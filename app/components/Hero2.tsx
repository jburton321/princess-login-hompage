...
export function Hero2() {
  return (
    ...
    >
      ...
      <div
        id="member-login"
        className="relative z-20 -mt-16 flex min-h-[28rem] flex-1 flex-col justify-center overflow-hidden rounded-t-[2rem] bg-[linear-gradient(180deg,#ffffff_0%,#f9fbfd_100%)] px-6 py-10 sm:-mt-20 sm:px-12 sm:py-12 lg:mt-0 lg:min-h-0 lg:max-w-[50%] lg:rounded-t-none"
      >
